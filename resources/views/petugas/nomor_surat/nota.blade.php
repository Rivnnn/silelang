...
@section('title', 'Nota')
@section('page-title', 'Nota Dinas')

@php
    $showBackButton = true;
    $backUrl = route('petugas.nomor-surat');
    
    // Generate nomor nota otomatis untuk preview
    $userId = auth()->id();
    $idPetugas = str_pad($userId, 2, '0', STR_PAD_LEFT);
    
    // Urutan global (dari semua petugas)
    $totalGlobal = \App\Models\Nota::count();
    $urutanBerikutnya = $totalGlobal + 1;
    
    $nomorBerikutnya = $idPetugas . "/" . str_pad($urutanBerikutnya, 3, '0', STR_PAD_LEFT) . "-3/BSI-BDG KOTA";
@endphp
...
<div class="box">
    <div class="box-header">
        <h3>Form Nota Dinas</h3>
    </div>

    <!-- Preview Nomor Nota Berikutnya -->
    <div class="nomor-preview">
        <div class="icon">🔢</div>
        <div class="content">
            <strong>Nomor Nota Berikutnya:</strong>
            ...
            <div class="info">
                ...
                <span class="info-highlight">-3</span> = Kode Nota Dinas
            </div>
        </div>
    </div>

    <form method="POST" action="{{ route('petugas.surat.nota.store') }}">
        @csrf
        <div class="form-grid">
            ...
            <div class="form-group form-full">
                ...
                <input type="text" name="perihal" placeholder="Masukkan perihal nota" required>
            </div>
            
            <div class="form-group form-full">
                <label>Tujuan <span class="required">*</span></label>
                <input type="text" name="tujuan" placeholder="Masukkan tujuan nota" required>
            </div>
                ...
                <tr>
                    <td colspan="6">
                        <div class="empty-state">
                            ...
                            <p>Silakan tambahkan nota baru menggunakan form di atas</p>
                        </div>
                    </td>
                </tr>
                @endforelse
